...
// Hasta listesini goruntuleme fonksiyonu
void hastaListele() {
    struct Hasta *gecici = ilk;
    if (gecici == NULL) {
...
// Ilk hastayi isleme alma fonksiyonu
void hastaIslem() {
    if (ilk == NULL) {
...
// Recete yazma fonksiyonu (Reçete numarası üretir)
void receteYaz() {
    if (ilk == NULL) {
